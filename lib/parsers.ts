...
/**
 * Aggregated namespace object exposing every parser utility.
 * Provided for backward compatibility and ergonomic access; prefer importing
 * the individual functions directly when bundle-size matters, since named
 * imports are tree-shakable and namespace access is not.
 *
 * @example
 * ```typescript
